...
Para evaluar el efecto del solver MIP en el tiempo de resolución, se ejecutó el mismo modelo ILP \emph{(Pyomo, idéntica formulación)} con dos solvers: HiGHS \cite{highs2024} y GLPK. En GLPK se fijó un límite de tiempo de 300 segundos (5 minutos). Los resultados se resumen en la Tabla~\ref{tab:resultados}.
...
Tiempo de resolución & $\approx$ 18 s & $> 300$ s (\textit{timeout}) \\
