...
\hline
Python \parencite{python3} & 3.12+ & Lenguaje de programación \\
Pyomo \parencite{pyomo2021} & 6.7+ & Modelado algebraico de optimización \\
HiGHS \parencite{highs2024} & 1.7+ & Solver LP/MIP \\
NetworkX \parencite{networkx2008} & 3.2+ & Manipulación de grafos \\
NumPy \parencite{numpy2020} & 1.26+ & Cómputo numérico \\
Matplotlib \parencite{matplotlib2007} & 3.8+ & Visualización \\
Jupyter \parencite{jupyter2016} & 7.0+ & Notebook interactivo \\
\hline
\end{tabular}
\end{table}
